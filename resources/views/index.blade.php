        ...
        <div class="lg:grid lg:grid-cols-2 gap-4 space-y-4 md:space-y-0 mx-4">
            ...
            <div class="bg-gray-50 border border-gray-200 rounded p-6">
                <div class="flex">
                    ...
                    <div>
                        <h3 class="text-2xl">
                            <a href="show">Senior Laravel Developer</a>
                        </h3>
            ...
            <div class="bg-gray-50 border border-gray-200 rounded p-6">
                <div class="flex">
                    ...
                    <div>
                        <h3 class="text-2xl">
                            <a href="show">Full-Stack Engineer</a>
                        </h3>
            ...
            <div class="bg-gray-50 border border-gray-200 rounded p-6">
                <div class="flex">
                    ...
                    <div>
                        <h3 class="text-2xl">
                            <a href="show">Laravel Developer</a>
                        </h3>
                        <div class="text-xl font-bold mb-4">
                            Wayne Enterprises
                        </div>
            ...
            <div class="bg-gray-50 border border-gray-200 rounded p-6">
                <div class="flex">
                    ...
                    <div>
                        <h3 class="text-2xl">
                            <a href="show">Backend Laravel Dev</a>
                        </h3>
                        <div class="text-xl font-bold mb-4">
                            Skynet Systems
                        </div>
            ...
            <div class="bg-gray-50 border border-gray-200 rounded p-6">
                <div class="flex">
                    ...
                    <div>
                        <h3 class="text-2xl">
                            <a href="show">Junior Developer</a>
                        </h3>
                        <div class="text-xl font-bold mb-4">
                            Wonka Industries
                        </div>
